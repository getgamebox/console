...
dotnet publish src\GameBox.Console\GameBox.Console.csproj -c Release /p:Version=$versionNormalized /p:AssemblyVersion=$assemblyVersion /p:FileVersion=$fileVersion --self-contained false
